...
export const TICKETS_DATA = [
  {
    id: 'enhypen-superior',
    eventTitle: "ENHYPEN",
    subTitle: "04/07/2026 • Nubank Parque, São Paulo",
    venue: "Nubank Parque",
    countText: "4 Ingressos",
    ticketQuantity: 4,
    dateText: "Sáb 04 20:00",
    ...
    start: "20:00",
    ticketsList: [
      { priceInfo: "Meia - R$ 190,00", qrCodeBase: "ENHYPEN-SUP-M1" },
      { priceInfo: "Meia - R$ 190,00", qrCodeBase: "ENHYPEN-SUP-M2" },
      { priceInfo: "Inteira - R$ 380,00", qrCodeBase: "ENHYPEN-SUP-I1" },
      { priceInfo: "Inteira - R$ 380,00", qrCodeBase: "ENHYPEN-SUP-I2" }
    ]
  },
  {
    id: 'enhypen-pista',
    ...
    start: "20:00",
    ticketsList: [
      { priceInfo: "Meia - R$ 210,00", qrCodeBase: "ENHYPEN-PISTA-M1" },
      { priceInfo: "Meia - R$ 210,00", qrCodeBase: "ENHYPEN-PISTA-M2" },
      { priceInfo: "Inteira - R$ 420,00", qrCodeBase: "ENHYPEN-PISTA-I1" },
      { priceInfo: "Inteira - R$ 420,00", qrCodeBase: "ENHYPEN-PISTA-I2" }
    ]
  },
  {
    id: 'enhypen-inferior',
    ...
    start: "20:00",
    ticketsList: [
      { priceInfo: "Meia - R$ 250,00", qrCodeBase: "ENHYPEN-INF-M1" },
      { priceInfo: "Meia - R$ 250,00", qrCodeBase: "ENHYPEN-INF-M2" },
      { priceInfo: "Inteira - R$ 500,00", qrCodeBase: "ENHYPEN-INF-I1" },
      { priceInfo: "Inteira - R$ 500,00", qrCodeBase: "ENHYPEN-INF-I2" }
    ]
  },
  {
    id: 'enhypen-premium',
    ...
    sortDate: "2026-07-04",
    fullDate: "04/07/2026",
    section: "Pista Premium Itaú Personnalité",
    gate: "PORTÃO A",
    rowInfo: "Não numerado",
    open: "16:00",
    start: "20:00",
    ticketsList: [
      { priceInfo: "Meia - R$ 400,00", qrCodeBase: "ENHYPEN-PREM-M1" },
      { priceInfo: "Meia - R$ 400,00", qrCodeBase: "ENHYPEN-PREM-M2" },
      { priceInfo: "Inteira - R$ 800,00", qrCodeBase: "ENHYPEN-PREM-I1" },
      { priceInfo: "Inteira - R$ 800,00", qrCodeBase: "ENHYPEN-PREM-I2" }
    ]
  },
  {
    id: 'weeknd-arquibancada',
    eventTitle: "THE WEEKND: AFTER HOURS TIL DAWN com ANITTA",
    subTitle: "01/05/2025 • Estádio Morumbis, São Paulo",
    venue: "Estádio Morumbis",
    countText: "4 Ingressos",
    ticketQuantity: 4,
    dateText: "Qui 01 21:00",
    ...
    start: "21:00",
    ticketsList: [
      { priceInfo: "Meia - R$ 275,00", qrCodeBase: "WEEKND-ARQ-M1" },
      { priceInfo: "Meia - R$ 275,00", qrCodeBase: "WEEKND-ARQ-M2" },
      { priceInfo: "Inteira - R$ 550,00", qrCodeBase: "WEEKND-ARQ-I1" },
      { priceInfo: "Inteira - R$ 550,00", qrCodeBase: "WEEKND-ARQ-I2" }
    ]
  },
  {
    id: 'weeknd-pista',
    ...
    monthLabel: "Maio 2025",
    section: "Pista",
    gate: "PORTÃO 02, 04, 18",
    rowInfo: "Não numerado",
    open: "16:00",
    start: "21:00",
    ticketsList: [
      { priceInfo: "Meia - R$ 375,00", qrCodeBase: "WEEKND-PISTA-M1" },
      { priceInfo: "Meia - R$ 375,00", qrCodeBase: "WEEKND-PISTA-M2" },
      { priceInfo: "Inteira - R$ 750,00", qrCodeBase: "WEEKND-PISTA-I1" },
      { priceInfo: "Inteira - R$ 750,00", qrCodeBase: "WEEKND-PISTA-I2" }
    ]
  },
  {
    id: 'weeknd-superior',
    ...
    start: "21:00",
    ticketsList: [
      { priceInfo: "Meia - R$ 455,00", qrCodeBase: "WEEKND-SUP-M1" },
      { priceInfo: "Meia - R$ 455,00", qrCodeBase: "WEEKND-SUP-M2" },
      { priceInfo: "Inteira - R$ 910,00", qrCodeBase: "WEEKND-SUP-I1" },
      { priceInfo: "Inteira - R$ 910,00", qrCodeBase: "WEEKND-SUP-I2" }
    ]
  },
  {
    id: 'weeknd-inferior',
    ...
    start: "21:00",
    ticketsList: [
      { priceInfo: "Meia - R$ 470,00", qrCodeBase: "WEEKND-INF-M1" },
      { priceInfo: "Meia - R$ 470,00", qrCodeBase: "WEEKND-INF-M2" },
      { priceInfo: "Inteira - R$ 940,00", qrCodeBase: "WEEKND-INF-I1" },
      { priceInfo: "Inteira - R$ 940,00", qrCodeBase: "WEEKND-INF-I2" }
    ]
  }
];
