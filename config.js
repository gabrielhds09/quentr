...
export const styles = StyleSheet.create({
  ...
  blueHeaderContainer: { position: 'relative', height: 310, width: '100%', backgroundColor: COLORS.blueHeader, borderTopLeftRadius: 14, borderTopRightRadius: 14, overflow: 'hidden', },
  ...
  ticketBoxTop: { padding: 20, backgroundColor: COLORS.white, borderBottomLeftRadius: 4, borderBottomRightRadius: 4, marginBottom: 1.5, paddingBottom: 25 },
  ticketBoxBottom: { paddingHorizontal: 20, paddingVertical: 22, backgroundColor: COLORS.white, borderRadius: 14, borderTopLeftRadius: 4, borderTopRightRadius: 4 },
