...
export const styles = StyleSheet.create({
  ...
  ticketBoxTop: { padding: 20, backgroundColor: COLORS.white, borderBottomLeftRadius: 16, borderBottomRightRadius: 16, marginBottom: 12 },
  ticketBoxBottom: { padding: 20, backgroundColor: COLORS.white, borderRadius: 16 },
  ...
  label: { color: COLORS.labelGrey, fontSize: 9, fontWeight: '700', marginBottom: 2, textTransform: 'uppercase' },
  valueTitle: { color: COLORS.valueBlack, fontSize: 16, fontWeight: '700', lineHeight: 20, marginBottom: 4 },
  moreInfoBtn: { backgroundColor: '#EBF8FF', paddingVertical: 8, borderRadius: 8, alignItems: 'center', width: '100%', marginTop: 8 },
  moreInfoText: { color: '#0070E0', fontSize: 12, fontWeight: '700' },
  divider: { height: 1, backgroundColor: '#F2F2F2', marginVertical: 18 },
  detailsGrid: { flexDirection: 'column' },
  gridRow: { flexDirection: 'row', justifyContent: 'space-between' },
  valueBold: { color: COLORS.valueBlack, fontSize: 16, fontWeight: '700' },
});