...
export const styles = StyleSheet.create({
  ...
  blueHeaderContainer: { position: 'relative', height: 280, width: '100%', backgroundColor: COLORS.blueHeader, borderTopLeftRadius: 16, borderTopRightRadius: 16, overflow: 'hidden', },
  ...
  ticketBoxBottom: { paddingHorizontal: 20, paddingVertical: 22, backgroundColor: COLORS.white, borderRadius: 16, borderTopLeftRadius: 4, borderTopRightRadius: 4 },
