...
export const styles = StyleSheet.create({
  ...
  blueHeaderContainer: { position: 'relative', height: 340, width: '100%', backgroundColor: COLORS.blueHeader, borderTopLeftRadius: 10, borderTopRightRadius: 10, overflow: 'hidden', },
  ...
  ticketBoxTop: { padding: 20, backgroundColor: COLORS.white, borderBottomLeftRadius: 2, borderBottomRightRadius: 2, marginBottom: 1.5, paddingBottom: 25 },
  ticketBoxBottom: { paddingHorizontal: 20, paddingVertical: 22, backgroundColor: COLORS.white, borderRadius: 14, borderTopLeftRadius: 2, borderTopRightRadius: 2 },
